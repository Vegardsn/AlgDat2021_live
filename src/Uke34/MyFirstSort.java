...
public class MyFirstSort {
    public static void main(String[] args){
        ...
        for (int k = 0; k<values.length-1; k++){
            ...
            //Vi må utføre ordentlig testing før vi faktisk kan stole på kildekoden
            int max_index= findMax(values, 0, values.length-1);
    ...
    /**
     * Findmax - finner index til største tallet i et array,
